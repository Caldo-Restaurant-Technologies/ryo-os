...
use crate::config::{
    ...
    HATCHES_SLOT_ID, HATCH_CLOSE_TIMES, HATCH_TIMEOUT, HEATER_OUTPUT_ID, HEATER_SLOT_ID,
    NODE_D_MOTOR_ID, NODE_LOW_THRESHOLDS, NUMBER_OF_NODES, PESTO_CAVATAPPI_RECIPE,
    POTATO_HASH_RECIPE, SEALER_ACTUATOR_ID, SEALER_ANALOG_INPUT, SEALER_EXTEND_ID,
    SEALER_EXTEND_SET_POINT, SEALER_HEATER, SEALER_MOVE_DOOR_TIME, SEALER_MOVE_TIME,
...
pub async fn pull_before_flight(io: RyoIo) -> RyoState {
    ...
    let mut state = RyoState::new_with_recipe(POTATO_HASH_RECIPE);
