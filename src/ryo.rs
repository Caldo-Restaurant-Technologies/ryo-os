...
use crate::config::{
    ...
    GRIPPER_POSITIONS, HATCHES_CLOSE_OUTPUT_IDS, HATCHES_OPEN_OUTPUT_IDS, HATCHES_OPEN_TIME,
    HATCHES_SLOT_ID, HATCH_CLOSE_TIMES, SEALER_ACTUATOR_ID, SEALER_EXTEND_ID, SEALER_HEATER,
