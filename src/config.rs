...
pub const HATCHES_OPEN_SET_POINTS: [isize; 4] = [200, 200, 200, 200];
pub const HATCHES_CLOSE_SET_POINTS: [isize; 4] = [4200, 4200, 4200, 4200];
pub const HATCH_OVERSHOOT: isize = 95;
