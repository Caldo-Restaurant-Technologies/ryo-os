...
pub const NODE_A_COEFFICIENTS: [f64; 4] = [-4373300.24661942, -4616499.81690381, -4915150.63523822, -4737729.66482573];
pub const NODE_B_COEFFICIENTS: [f64; 4] = [-8.25505680e+06, -4.04720247e+06, 5.70742589e+06, 3.65643421e+06];
pub const NODE_C_COEFFICIENTS: [f64; 4] = [3214287.51552896, 4271317.5049333, -5033544.57756198, -5363519.70354506];
pub const NODE_D_COEFFICIENTS: [f64; 4] = [-5897877.72181665, 5263019.161459, -4005678.071311, 4000763.38549006];
pub const NODE_COEFFICIENTS: [[f64; 4]; 4] = [NODE_A_COEFFICIENTS, NODE_B_COEFFICIENTS, NODE_C_COEFFICIENTS, NODE_D_COEFFICIENTS];
...
pub const GANTRY_ACCELERATION: f64 = 100.;
